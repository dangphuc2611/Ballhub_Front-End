...
import { Github, Chrome, Facebook } from "lucide-react"; // Sử dụng Lucide icon hoặc Image cho logo
...
function LoginContent() {
  ...
  return (
    <div className="min-h-[calc(100vh-128px)] flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-gray-100 transition-all">
        <h1 className="text-2xl font-bold text-center mb-2">Chào mừng trở lại!</h1>
        <p className="text-gray-500 text-center text-sm mb-8">Vui lòng đăng nhập để tiếp tục mua sắm tại BallHub</p>
