...
>>>>>>> ae72dbc (done)
  ...
  const [appliedPromo, setAppliedPromo] = useState<any>(null);
  const [qrModal, setQrModal] = useState<{ show: boolean; url: string; orderId: number | null }>({
    show: false,
    url: "",
    orderId: null,
  });
...
>>>>>>> ae72dbc (done)
  ...
  const totalPayment = cartData.totalAmount - (appliedPromo ? appliedPromo.discountAmount || appliedPromo.maxDiscountAmount || 0 : 0) + shippingFee;
