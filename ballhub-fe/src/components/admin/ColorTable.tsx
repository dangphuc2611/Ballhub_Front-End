    ...
    <div className="bg-white rounded-[28px] border border-slate-100 shadow-sm overflow-hidden">
      ...
      <div className="flex justify-between items-center px-8 py-6 border-b border-slate-50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-black text-slate-800 text-base">Quản lý Màu sắc</h3>
            {totalElements != null && (
              <p className="text-[11px] text-slate-400 font-medium">{totalElements} màu</p>
            )}
          </div>
        </div>
        <button
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50/60">
            <tr className="text-slate-400 text-[11px] uppercase">
              ...
              <th className="text-left px-4 py-4 font-semibold">Tên Màu</th>
              ...
              <tr>
                <td colSpan={4} className="py-16 text-center">
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-slate-400 text-sm font-medium">Chưa có màu sắc nào</p>
                  </div>
                </td>
              </tr>
            )}
